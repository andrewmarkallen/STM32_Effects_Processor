...
// assemble 6-byte data in WM5102 format - I think we have to transmit it in 8-bit bytes

// this was the WM8731 version,
//	uint8_t Byte1 = ((RegisterAddr<<1)&0xFE) | ((RegisterValue>>8)&0x01); // first 7 bits are register address, LSB is bit 8 of
//                                                                              // 9-bit  register value
//	uint8_t Byte2 = RegisterValue&0xFF;                                   // bits 7 thru 0 of register value
//
